package com.example.currencyexchangerapp.presentation.utils

/**
 * Created by John Ralph Dela Rosa on 11/25/2025.
 */
val currencyNames = mapOf(
    ...
    "MRO" to "Mauritanian Ouguiya (Old)",
    ...
    "STD" to "São Tomé and Príncipe Dobra (Old)",
